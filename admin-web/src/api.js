...
export const api={
  login:data=>http.post('/public/admin/login',data),overview:()=>http.get('/admin/reports/overview'),sales:()=>http.get('/admin/reports/sales'),verificationTrend:(from,to)=>http.get('/admin/reports/verification-trend',{params:{from,to}}),salesByMethod:(from,to)=>http.get('/admin/reports/sales-by-method',{params:{from,to}}),category:(from,to)=>http.get('/admin/reports/category',{params:{from,to}}),
